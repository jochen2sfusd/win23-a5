...
# Test 04: Ensure program errors with another invalid operand
if $CALCULATOR 3 ! 2; then  # If the return code of $PROGRAM is zero (i.e. success)...
  echo 'ERROR! An invalid run of the application (3 ! 2) apparently succeeded?!'
  exit 1
fi

# Test 05: Ensure program errors with another invalid input
...
# Tests 6 and onwards will be another shell script in tests